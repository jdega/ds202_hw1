...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hello, I am **Jonathan DeGardner**, I am a senior majoring in *Management Information Systems* and minoring in *Data Science*. I am originally from White Bear Lake, Minnesota. I enjoy being outside biking, golfing, and hiking. I also like relaxing and watching TV or playing video games.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A machine learning engineer is a job that is related to data science and has responsibilities like researching and developing the use of systems to detect and classify objects based on the scenario. [Computer Vision and Machine Learning Engineer](https://www.google.com/search?q=data+science+jobs&rlz=1C1CHFX_enUS757US757&oq=data+science+&aqs=chrome.1.69i57j0l4j69i61l3.2901j0j7&sourceid=chrome&ie=UTF-8&ibp=htl;jobs&sa=X&ved=2ahUKEwiusb2PjqrrAhXXQc0KHbeaCmAQp4wCMAB6BAgKEAE#fpstate=tldetail&htivrt=jobs&htiq=data+science+jobs&htidocid=egVMf3ugVvUVl9uEAAAAAA%3D%3D)
    ![Self-Driving Car](C:\Users\Jonny DeGardner\Desktop\Cawlige\S.S1\DS 202\ds202_hw1\image.jpg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I enjoy topics such as technology, health, sports, and many more.
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: Done - git version 2.28.0.windows.1
  
9. Configure your git username and user email by modifying and entering the following commands into the terminal

    ```
    git config --global user.name "Jonathan DeGardner"
    git config --global user.email "jondeg@iastate.edu"
    ```
